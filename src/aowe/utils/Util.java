...
public class Util {
    ...
    public static final String AOWE_ASSETS = "resources/";
    ...
    public static final String TOWER_STAGE_CLEAR = "tower_stage_clear";
    public static final String TOWER_BOSS_CHEST = "tower_boss_chest";
    public static final String TOWER_OVER = "tower_over";
    public static final String TOWER_BARRACKS = "tower_barracks";
    public static final String TOWER_MEDICAL = "tower_medical";
    public static final String TOWER_TREAT = "tower_treat";
    ...
    public static final String MYSTIC_TERRAIN_BACKGROUND = AOWE_ASSETS + "mystic_tower_background" + PNG_EXT;
    ...
    public static final String PARALLEL_SPACE_BACKGROUND = AOWE_ASSETS + "parallel_space_background" + PNG_EXT;
    public static final String MAGIC_TOWER_BACKGROUND = AOWE_ASSETS + "tower_background" + PNG_EXT;
