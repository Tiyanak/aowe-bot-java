 ...
 */
public class MysticTowerAction extends AbstractAction {

    public MysticTowerAction(String name) {
        super(name);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MysticTower mysticTower = new MysticTower();
        gkl.addGame(mysticTower);
